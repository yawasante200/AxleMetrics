...
import { formSchema, FormValues, GrowthRateType } from './types';
  ...
  return (
    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
      ...
      <button
        ...
        disabled={vehicleDataLength === 0 || (useVariableGrowthRate && growthRateType === GrowthRateType.YEARLY && growthRatesLength === 0)}
      >
        Calculate Design ESAL
      </button>
    </form>
  );
};
