...
export const generateRigidOriginalPDF = async (
  ...
  const templatePath = '/Rigid Original AASHO ESAL Report.pdf';
  ...
  currentPage.drawText(`${config.ptVal}`, {
    x: 226.6,
    y: 405,
    size: 10,
    color: rgb(0, 0, 0),
  });
  currentPage.drawText(`${config.dVal}`, {
    x: 406.6,
    y: 405,
    size: 10,
    color: rgb(0, 0, 0),
  ...
  saveAs(blob, 'Rigid_Original_AASHO_ESAL_Report.pdf');
};
